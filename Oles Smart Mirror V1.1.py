...
class Wheather_data(Frame):
    def __init__(self, *args, period):
        ...
        #self.wind_dir_photo_path = "\sym\wind_dir\white_arrow3.png" #for use on mirror
    ...
    def get_wheather_data(self, period):
        ...
        #Symbol icon config
        #self.symbol_path = "\sym\b100\%s.png" %(self.forecast1.get("symbolnumber")) #for use on mirror
        ...
        while True:
            try:
                ...
                #self.symbol_path = "\sym\b100\%sm.png" %(self.forecast1.get("symbolnumber")) #for use on mirror
        ...
        #rotated_image.save("\sym\wind_dir\current.png") #for use on mirror
        #self.wind_dir_path = "\sym\wind_dir\current.png" #for use on mirror
