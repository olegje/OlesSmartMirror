...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.clock.grid(row=1, column=1, sticky="NW", padx=100, pady=100)
        self.home_status = Home_status(self)
        self.home_status.grid(row=2, column=1, sticky="SE", padx=100, pady=100)
        self.wheather_data1 = Wheather_data(self, period=0) #Creates a object from the Wheather data and passes in the frame mainwindow
        self.wheather_data1.grid(row=1, column=2, sticky="NE", padx=100, pady=100)
        self.wheather_data2 = Wheather_data(self, period=0) #Creates a object from the Wheather data and passes in the frame mainwindow
        self.wheather_data2.grid(row=2, column=2, sticky="NE", padx=100, pady=100)
