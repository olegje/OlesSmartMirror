...
class Wheather_data(Frame):
    def __init__(self, *args, **kwargs):
        # all variables here
        self.wind_dir_photo_path = r"\\NSA325\Nettverkshardisk\Jonny\Programmer\Oles Smart Mirror\sym\wind_dir\orginalnorth.png"
    ...
    def get_wheather_data(self):
        ...
        self.forecast1 = self.get_forecast_data(self.get_period()) #Creates a dictonery whit the forecast data from the period that is passed in
        ...
        #Denne under kommer til å lage error når symbolnumber har en bokstav bak. må fikses error på symbolnummer 03
        ...
        size = 100, 100
        rotated_image = src_image.rotate(angle, expand=1).resize(size)
        ...
        self.period_frame.after(60000, self.get_wheather_data)
...
class FullscreenWindow:
    ...
    def __init__(self): #This sets up the main window and the main frame
        ...
        self.wheather_data1 = Wheather_data(self.Frame,) #Creates a object from the Wheather data and passes in the frame mainwindow
        self.wheather_data1.pack(side=TOP, anchor=NE, padx=100, pady=100)
        self.wheather_data2 = Wheather_data(self.Frame,) #her må jeg få til å sette in neste periode
